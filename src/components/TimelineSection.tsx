  ...
  return (
    <section id="timeline" className="py-20 ornament-bg">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <button
                  ...
                  className={`flex-shrink-0 mx-2 p-4 rounded-xl transition-all duration-300 ${
                    selectedEvent === index
                      ...
                      : 'bg-white text-foreground hover: border border-border'
                  }`}
                >
        ...
        {/* Event Details with animation on change */}
        <Zoom key={selectedEvent} triggerOnce>
          <div className="bg-card rounded-2xl shadow-lg overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              {/* Image */}
              <Fade direction="right" triggerOnce key={`image-${selectedEvent}`}>
