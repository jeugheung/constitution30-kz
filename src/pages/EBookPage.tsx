...
const EbookPage = () => {
  ...
  const expandedPages = wordPages.flatMap(article => splitLongArticle(article));

  const totalPages = expandedPages.length + 1;
    ...
    <div className={styles.wrapper}>
      <div className={styles.container}>
        <div className={styles.bookWrapper}>
          ...
          {isMobile ? (
            <MobileBook expandedPages={expandedPages} bookRef={bookRef} handleFlip={handleFlip} />
          ) : (
            <HTMLFlipBook
              ref={bookRef}
              width={550}
