    ...
    <div className="relative hero-pattern pb-8">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto -mt-[140px] bg-card p-6 rounded-xl border border-border shadow-lg overflow-hidden">
        ...
        <p className="mb-4 text-foreground leading-relaxed text-lg">
          Граждане имеют право на образование. Среднее образование обязательно.
          Государство гарантирует доступность образования для всех граждан.
        </p>

        <p className="mb-4 text-foreground leading-relaxed">
          Право на образование в Республике Казахстан — одно из важнейших
          социальных прав, закреплённых в Конституции и регулируемых отраслевыми
          законами. Оно гарантирует каждому гражданину возможность получить
          образование вне зависимости от социального положения, национальности,
          вероисповедания и других признаков.
        </p>
        ...
        <p className="mb-4">
          <strong>Статья 30 Конституции Республики Казахстан:</strong>
          <br />
          1. Граждане имеют право на образование.
          <br />
          2. Среднее образование обязательно.
          <br />
          3. Государство гарантирует бесплатность среднего образования в
          государственных учебных заведениях.
          <br />
          4. Граждане имеют право на получение на конкурсной основе бесплатного
          высшего образования в государственных учебных заведениях.
        </p>

        <h2 className="text-2xl font-semibold mt-6 mb-2 text-foreground">
          Что включает в себя право на образование
        </h2>

        <h3 className="text-xl font-semibold mt-4 mb-2 text-foreground">
          1. Обязательность среднего образования
        </h3>
        <ul className="list-disc pl-6 mb-4">
          <li>В Казахстане среднее образование — обязательно.</li>
          <li>
            Оно включает начальное, основное среднее и общее среднее
            образование.
          </li>
          <li>
            Родители обязаны обеспечить обучение своих детей до завершения
        ...
        <ul className="list-disc pl-6 mb-4">
          <li>
            Образование должно быть доступным и открытым для всех без
            дискриминации.
          </li>
          <li>
            Государство создаёт условия для получения образования:
        ...
        <h3 className="text-xl font-semibold mt-4 mb-2 text-foreground">
          3. Бесплатность государственного образования
        </h3>
        <ul className="list-disc pl-6 mb-4">
          <li>
            Образование в государственных школах и колледжах — бесплатное.
          </li>
          <li>
            Высшее образование может быть бесплатным на конкурсной основе (по
            грантам).
          </li>
          <li>
            Существуют меры поддержки: стипендии, питание, транспорт, учебники,
            льготы для инвалидов, сирот, многодетных семей и др.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>
            Международные договоры, ратифицированные Казахстаном (например,
            Конвенция ООН о правах ребёнка)
          </li>
        </ul>

        <h2 className="text-2xl font-semibold mt-6 mb-2 text-foreground">
          Уровни образования в Казахстане
        </h2>
          ...
          <table className="w-full border border-border text-left text-sm">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="px-4 py-2 border border-border">
                  Бесплатное (в гос. школах)
                </td>
              </tr>
              <tr>
                <td className="px-4 py-2 border border-border">
                  Основное среднее (5–9)
                </td>
                <td className="px-4 py-2 border border-border">Да</td>
                <td className="px-4 py-2 border border-border">
                  Бесплатное (в гос. школах)
              ...
              <tr>
                ...
                <td className="px-4 py-2 border border-border">Нет</td>
                <td className="px-4 py-2 border border-border">
                  Бесплатное (по грантам) или платное
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <ul className="list-disc pl-6 mb-6">
          ...
          <li>
            Цифровизация образования: платформы Daryn, BilimLand, OpenU.kz
          </li>
        </ul>
        ...
        <p className="mb-6">
          ...
          <ul className="list-disc pl-6 mt-2">
            <li>
              Гарантирует равный доступ к знаниям и развитию способностей.
            </li>
            <li>Обеспечивает обязательное и бесплатное среднее образование.</li>
            <li>
              Создает основу для личного и профессионального роста граждан.
            </li>
            <li>
              Поддерживается государственной политикой и социальными мерами.
            </li>
          </ul>
        </p>
