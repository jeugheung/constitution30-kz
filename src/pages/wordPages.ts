...
4. Правовое положение и организация деятельности Уполномоченного по правам человека определяются конституционным законом.`
  ...
  },
  {
    number: 84,
    title: `Статья 84`,
    content: `Раздел VIII Местное государственное управление и самоуправление`
  },
  {
    number: 85,
    title: `Статья 85`,
